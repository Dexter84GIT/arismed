                    ...
                    <div class="block info df aifs gap30">
                        ...
                        <div class="column df fdc gap30">
                            ...
                            <div class="row df aife controls gap20 jcsb">
                                ...
                                <div class="add df aic gap20 test">
                                    <form class="add df aic gap20 cart" method="post" action="<?php echo esc_url( $product->add_to_cart_url() ); ?>">
                                        <?php include get_template_directory() . '/inc/page-checkout/parts/quantity.php'; ?> 
                                        <?php include get_template_directory() . '/inc/page-checkout/parts/add-to-cart.php'; ?>
                                    </form>
                                </div>
                            </div>
                        </div>
