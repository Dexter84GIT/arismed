        <section class="mainCatalog catalog section">
            <div class="patterns bg">
                ...
                <div class="pattern_004">
                    <img src="<?php bloginfo('template_directory'); ?>/img/plus_004.png" alt="plus">
                </div>
            </div>
            <div class="container df fdc gap30">
                ...
                ?>
                    ...
                    <a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class="seeMore mobile">Показать еще</a>
                </div>
