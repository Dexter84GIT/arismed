      <section class="account section">
            <div class="container">
                ...
                <form method="post" id="registrationForm" class="checkoutForm df fdc gap30">
                            ...
                            <div class="row">
                                <div class="field">
                                    <input type="text"
                                           ...
                                           autocomplete="name"
                                           value="<?php echo isset($_POST['account_full_name']) ? esc_attr(wp_unslash($_POST['account_full_name'])) : ''; ?>"
                                           required>
                                </div>
                            </div>
                            ...
                            <div class="row row2 df aic gap20">
                                ...
                                <div class="field">
                                    <input type="tel"
                                           ...
                                           name="billing_phone"
                                           autocomplete="tel"
                                           value="<?php echo isset($_POST['billing_phone']) ? esc_attr(wp_unslash($_POST['billing_phone'])) : ''; ?>">
                                </div>
                            </div>
