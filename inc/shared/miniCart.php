...
<div class="miniCartBtn dropBtn">
    <div class="iconLink tpr">
        ...
        <p class="count"><?php echo esc_html((string) $count); ?></p>
    </div>

    <div class="miniCart drop df fdc gap30" data-nonce="<?php echo esc_attr($nonce); ?>">
            ...
            <?php if ($cart && $count > 0) : ?>
                ...
                ?>
                    <div class="item df aic gap20" data-key="<?php echo esc_attr($cart_item_key); ?>">
                        ...
                        <button class="delete" type="button" aria-label="Удoлить">
                            <span></span>
                        </button>
                    </div>
                <?php endforeach; ?>
        ...
        <div class="overall df aic gap20">
            ...
            <p class="druk sum"><?php echo esc_html(number_format_i18n($total, 0)); ?><span class="currency"><?php echo esc_html($currency); ?></span></p>
        </div>

        <a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="toCheckout df aic gap10 jcc">
