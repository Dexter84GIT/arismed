<div class="searchBtn dropBtn" id="searchBtn">
    ...
    <div class="search drop df fdc gap30">
        <div class="input">
            <input type="search" placeholder="Начните вводить название (минимум 3 символа)">
        </div>
        <div class="result df fdc gap20">
